...
import { BarChart, Bar, XAxis, YAxis, Tooltip, CartesianGrid, Legend, LineChart, Line, ResponsiveContainer, PieChart, Pie, Cell } from 'recharts';
/**
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <LineChart data={chartData}>
                            ...
                            {rootCauseKeys.map((rootCause, index) => (
                                <Line key={index} type="monotone" dataKey={rootCause} stroke={`hsl(${index * 50}, 70%, 50%)`} name={rootCause} />
                            ))}
                        </LineChart>
                    </ResponsiveContainer>
                </Grid>
